...
@Component({
  ...
  styleUrls: ['./comprainsertar.component.scss']
})
export class ComprainsertarComponent {
 ...
 constructor(private router: Router, private sproductos: ProductoService, private sproveedor: TerceroService, private scompra: CompraService){}
  ...
  consulta_productos(){
    this.sproductos.consulta().subscribe((resultado:any) => {
